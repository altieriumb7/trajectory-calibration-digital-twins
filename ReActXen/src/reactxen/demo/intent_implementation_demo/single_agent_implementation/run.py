"""CLI entry point for single-agent benchmark."""
...
from single_agent_implementation.benchmark_runner import run_benchmark, save_results


def main():
    parser = argparse.ArgumentParser(description="Run PHMForge single-agent benchmark")
    parser.add_argument(
        "--scenario-file",
        type=str,
    ...
    print(f"Running single-agent benchmark:")
