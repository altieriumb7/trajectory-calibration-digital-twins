...
telemetry. We audited a working pipeline built to evaluate exactly those signals
on an industrial prognostics benchmark, and found that none of its features
measured the system it claimed to describe. Token logprobs were synthesised by
...
\textbf{Limitations.} The empirical section illustrates rather than establishes.
